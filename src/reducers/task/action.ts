...
export const loadTasks = createAction<TaskLookupParam>(LOAD);
export const startedLoadTasks = createAction(LOAD_STARTED);
export const successedLoadTasks = createAction<Task[]>(LOAD_SUCCESSED);
export const failedLoadTasks = createAction<ErrorMessage>(LOAD_FAILED);
...
export const failedUpdateTask = createAction<ErrorMessage>(UPDATE_FAILED);
